...
class Patient(Process):
    ...
    def Phase0(self):
        Patient(self.BDPoint).Activate(self.BDPoint.Distributions.GetExponential(250))
    ...
    def Phase3(self):
        if(self.BloodType=="A" and self.BloodNeeded < len(self.BDPoint.BloodListA)):
            ...
            print("Pacjent od nr ID" + str(self.ID) + "otrzymal " + str(self.BloodNeeded) + " jednostek krwi typu B" )
            for i in range(self.BloodNeeded):
